  ...
  return (
    <div className="social-container">
      <section >
        ...
        <Button className="btnbottom social" href="mailto:vembarasugn@gmail.com" style={{backgroundColor: "#e1dbf5f1", color:"rgb(6, 6, 97)",justifyContent: "center"}} variant="outlined">
         <AiFillMail size="18px" style={{ minWidth: "32px" }}/>
         EMail Me 
        </Button>

        <Button className="btnbottom  social" href="tel:8098986851" style={{backgroundColor: "#e1dbf5f1", color:"rgb(6, 6, 97)",justifyContent: "center"}} variant="outlined">
         <FcPhoneAndroid size="19px" style={{ minWidth: "32px"}}/>
         Phone Call 
        </Button>

        <Button className="btnbottom  social" target="_blank" href="./Vembarasan N CV-updated.pdf" style={{backgroundColor: "#e1dbf5f1", color:"rgb(6, 6, 97)",justifyContent: "center"}} variant="outlined">
