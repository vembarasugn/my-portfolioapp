      ...
      { data.Projectdata.map((list) => (
          <Grid
            ...
            style={{ display: "flex", justifyContent: "center"}}
             key={list.id}
          > 
         <Card sx={{ minWidth:356 , maxWidth:356 }} className="card-hover" style={{backgroundColor:"#f3f3f3f1", borderRadius:"16px" , maxHeight:"515px", borderColor:"grey", borderWidth:"3px"}} variant="outlined"> 
          <CardActionArea>
          <CardMedia
           component="img"
           height="180"
